...
def my_account(request):
    ...
    return render(request, "legacy/studio/my_account.html", options)
...
def my_videos(request):
    ...
    return render(request, "legacy/studio/my_videos.html", options)
...
def my_playlists(request):
    ...
    return render(request, "legacy/studio/my_playlists.html", options)
...
def video_edit(request, video_id):
    ...
    return render(request, "legacy/studio/video_edit.html", options)
...
def playlist_edit(request, playlist_id):
    ...
    return render(request, "legacy/studio/playlist_edit.html", options)
