...
urlpatterns = [
    # This will still use the legacy views
    path("signup", views.signup, name="signup"),
    path("login", views.signin, name="signin"),
    path("logout", views.signout, name="signout"),
    # Single page web app
    path("", views.WebAppView.as_view(), name=""),
    path("<path:path>", views.WebAppView.as_view(), name="any"),
]

# Uncomment if you wanna use the legacy views
