...
const ROOT_DIR = path.join(PROJECT_ROOT_DIR, 'public/static/js');
const OUTPUT_DIR = ROOT_DIR;
const CONFIG_FILE = path.join(PROJECT_ROOT_DIR,'utils/minifyjs/terserrc.json');
...
const main = async () => {
    try {
        ...
        const allFiles = globSync(path.join(ROOT_DIR,'**/*'), {
